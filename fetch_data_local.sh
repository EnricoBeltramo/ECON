...
cp ./datazip/SMPL_python_v.1.0.0.zip ./data/smpl_related/models
...
cp ./datazip/mpips_smplify_public_v2.zip ./data/smpl_related/models
...
cp ./datazip/models_smplx_v1_1.zip ./data/smpl_related/models/
...
cp ./datazip/pixie_data.zip ./data/HPS
...
cp ./datazip/pymafx_data.zip ./data/HPS
